            ...
            >
                ...
                <SwiperSlide>
                    <div className='diary1'>
                        ...
                        <div className='essay'>“你若军训，便是晴天”，九月份，烈日当空，
                ...
                <SwiperSlide>
                    <div className='diary4'>
                        ...
                        <div className='action1'>
                            ...
                            <div className='action_body'>为了不被变成“煤老板”一定要涂好防晒霜或者喷雾及时补涂。</div>
                        </div>
                        <div className='action2'>
                            <div className='action_header'>晒伤修复</div>
                            <div className='action_body'>宿舍常备芦荟胶等晒后修复霜，妈妈再也不用担心我的皮肤晒伤了。</div>
                        </div>
                        <div className='action3'>
                            <div className='action_header'>鞋垫</div>
                            <div className='action_body'>胶鞋的鞋底薄，一双舒适的棉鞋垫会让你的军训体验upup。</div>
                        </div>
                        <div className='action4'>
                            <div className='action_header'>多喝水啊</div>
                            <div className='action_body'>在烈日下的训练105度，补水是非常重要的，记得携带水杯，及时补充水分，盐分最佳。</div>
                        </div>
                    </div>
                </SwiperSlide>
            </Swiper>
